...
>>>>>>> a753627ea69c7e6773d207413a77507bab9ee754
  ...
  it "parses depenencies from go.sum" do
    expect(described_class.analyse_contents("go.sum", load_fixture("go.sum"))).to eq({
        ...
        Bibliothecary::Dependency.new(name: "github.com/kr/text",
                                      requirement: "v0.1.0",
                                      type: "runtime",
                                      source: "go.sum"),
        Bibliothecary::Dependency.new(name: "github.com/replicon/fast-archiver",
                                      requirement: "v0.0.0-20121220195659-060bf9adec25",
                                      type: "runtime",
                                      source: "go.sum"),
        Bibliothecary::Dependency.new(name: "gopkg.in/yaml.v1",
                                      requirement: "v1.0.0-20140924161607-9f9df34309c0",
                                      type: "runtime",
                                      source: "go.sum"),
      ],
  ...
  it "parses dependencies from glide.yaml" do
    expect(described_class.analyse_contents("glide.yaml", load_fixture("glide.yaml"))).to eq({
                                                                                               ...
                                                                                               path: "glide.yaml",
                                                                                               dependencies: [
        Bibliothecary::Dependency.new(name: "gopkg.in/yaml.v2",
                                      requirement: "*",
                                      type: "runtime",
                                      source: "glide.yaml"),
        Bibliothecary::Dependency.new(name: "github.com/Masterminds/vcs",
                                      requirement: "^1.4.0",
                                      type: "runtime",
                                      source: "glide.yaml"),
        Bibliothecary::Dependency.new(name: "github.com/codegangsta/cli",
                                      requirement: "*",
                                      type: "runtime",
                                      source: "glide.yaml"),
        Bibliothecary::Dependency.new(name: "github.com/Masterminds/semver",
                                      requirement: "^1.0.0",
                                      type: "runtime",
                                      source: "glide.yaml"),
      ],
  ...
  it "parses dependencies from gb_manifest" do
    expect(described_class.analyse_contents("vendor/manifest", load_fixture("gb_manifest"))).to eq({
                                                                                                     ...
                                                                                                     dependencies: [
        Bibliothecary::Dependency.new(name: "github.com/gorilla/mux",
  ...
  it "parses dependencies from govendor vendor.json file" do
    expect(described_class.analyse_contents("vendor/vendor.json", load_fixture("vendor.json"))).to eq({
                                                                                                        ...
                                                                                                        dependencies: [
        Bibliothecary::Dependency.new(name: "github.com/Bowery/prompt",
                                      requirement: "d43c2707a6c5a152a344c64bb4fed657e2908a81",
                                      type: "runtime",
                                      source: "vendor/vendor.json"),
        Bibliothecary::Dependency.new(name: "github.com/dchest/safefile",
                                      requirement: "855e8d98f1852d48dde521e0522408d1fe7e836a",
                                      type: "runtime",
                                      source: "vendor/vendor.json"),
        Bibliothecary::Dependency.new(name: "github.com/google/shlex",
                                      requirement: "6f45313302b9c56850fc17f99e40caebce98c716",
                                      type: "runtime",
                                      source: "vendor/vendor.json"),
        Bibliothecary::Dependency.new(name: "github.com/pkg/errors",
                                      requirement: "a2d6902c6d2a2f194eb3fb474981ab7867c81505",
                                      type: "runtime",
                                      source: "vendor/vendor.json"),
        Bibliothecary::Dependency.new(name: "golang.org/x/tools/go/vcs",
